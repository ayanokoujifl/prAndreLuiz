import { getLista, novo } from "./acessa_dados_funcionarios.js";

let indiceSelecionado = -1;

async function cadastrarUsuario(usuario) {
  const API_URL = "https://prandreluiz.onrender.com/funcionarios/cadastrar"; //endpoint da api 
  console.log(usuario);
...
function excluir(event) {
  ...
  if (indiceSelecionado > -1) {
    ...
    alert("Selecione o funcionário que deseja excluir da base de dados.");
  }
}
